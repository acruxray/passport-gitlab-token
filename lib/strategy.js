 ...
 * @api public
 */
function GitLabTokenStrategy(options, verify) {
  options = options || {};
  options.authorizationURL = options.authorizationURL || 'https://gitlab.com/oauth/authorize';
  options.tokenURL = options.tokenURL || 'https://gitlab.com/oauth/token';

  OAuth2Strategy.call(this, options, verify);
  this.name = 'gitlab-token';
}

/**
 * Inherit from `OAuth2Strategy`.
 */
util.inherits(GitLabTokenStrategy, OAuth2Strategy);
 ...
 * @api protected
 */
GitLabTokenStrategy.prototype.authenticate = function(req, options) {
  options = options || {};
  var self = this;
 ...
 * @api protected
 */
GitLabTokenStrategy.prototype.userProfile = function(accessToken, done) {
  this._oauth2.get('https://gitlab.com/api/v3/user', accessToken, function (err, body, res) {
 ...
 * @api private
 */
GitLabTokenStrategy.prototype._loadUserProfile = function(accessToken, done) {
  var self = this;
...
/**
 * Expose `GitLabTokenStrategy`.
 */
module.exports = GitLabTokenStrategy;
